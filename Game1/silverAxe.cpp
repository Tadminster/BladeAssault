...
silverAxe::silverAxe() : Item()
{
	grade = ItemGrade::EPIC;

	icon = new ObImage(L"gear_icon_silverAxe.png");
	icon->pivot = OFFSET_B;
	...
	text_name = L"실버 액스";
	text_explanation = L"스킬 공격력이 20% 증가하고, 스킬 재사용 대기시간이 10% 감소합니다.";

	// 아이템의 능력치
	skillDamageScale = 0.2f;
	skillCooldownScale = 0.1f;
}
