...
player_damageReflection::player_damageReflection(
	Vector2 spawnPos,
	Vector2 dir,
	float speed,
	float range,
	...
	float explosionRange)
{
	...
	collider->scale = Vector2(400, 300);
...
void player_damageReflection::Update()
{
	Projectile::Update();
	//collider_range->Update();
}

void player_damageReflection::Render()
{
	if (GM->DEBUG_MODE)
		collider->Render();
}

void player_damageReflection::AfterEffect()
{
